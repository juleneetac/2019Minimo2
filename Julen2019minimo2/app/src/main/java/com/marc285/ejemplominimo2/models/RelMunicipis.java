...
public class RelMunicipis {
    ...
    @SerializedName("municipi_escut")    //de aqui
    @Expose
    private String municipiEscut;
    @SerializedName("municipi_bandera")    // de aqui
    @Expose
    private String municipiBandera;
    @SerializedName("municipi_vista")   // de aqui nombre habitantes, extension y altitud
    @Expose
